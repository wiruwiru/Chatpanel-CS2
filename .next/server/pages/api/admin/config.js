"use strict";(()=>{var e={};e.id=913,e.ids=[913],e.modules={666:e=>{e.exports=require("cookie")},829:e=>{e.exports=require("jsonwebtoken")},3480:(e,a,t)=>{e.exports=t(5600)},4202:(e,a,t)=>{t.r(a),t.d(a,{config:()=>u,default:()=>T,routeModule:()=>A});var n={};t.r(n),t.d(n,{default:()=>l});var o=t(3480),E=t(8667),i=t(6435),r=t(666),s=t(829),c=t(9404);async function l(e,a){if(await (0,c.dv)(),"POST"===e.method){let t=(0,r.parse)(e.headers.cookie||"").session;if(!t)return a.status(401).json({message:"Unauthorized"});try{(0,s.verify)(t,process.env.SESSION_SECRET)}catch(e){return a.status(401).json({message:"Unauthorized"})}}try{if("GET"===e.method){let e=await (0,c.zj)();a.status(200).json(e)}else if("POST"===e.method){let{key:t,value:n}=e.body;await (0,c.Nk)(t,n),a.status(200).json({message:"Configuration updated successfully"})}else a.status(405).json({message:"Method not allowed"})}catch(e){console.error("Error in config API:",e),a.status(500).json({message:"Internal server error"})}}let T=(0,i.M)(n,"default"),u=(0,i.M)(n,"config"),A=new o.PagesAPIRouteModule({definition:{kind:E.A.PAGES_API,page:"/api/admin/config",pathname:"/api/admin/config",bundlePath:"",filename:""},userland:n})},5600:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6435:(e,a)=>{Object.defineProperty(a,"M",{enumerable:!0,get:function(){return function e(a,t){return t in a?a[t]:"then"in a&&"function"==typeof a.then?a.then(a=>e(a,t)):"function"==typeof a&&"default"===t?a:void 0}}})},8667:(e,a)=>{Object.defineProperty(a,"A",{enumerable:!0,get:function(){return t}});var t=function(e){return e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE",e.IMAGE="IMAGE",e}({})},8954:(e,a,t)=>{t.d(a,{A:()=>o});let n=require("mysql2/promise"),o=t.n(n)().createPool({host:process.env.DB_HOST,user:process.env.DB_USER,password:process.env.DB_PASSWORD,database:process.env.DB_NAME,waitForConnections:!0,connectionLimit:10,queueLimit:0})},9404:(e,a,t)=>{t.d(a,{Nk:()=>s,dv:()=>i,zj:()=>r});var n=t(8954);let o=!1;async function E(e,a,t){try{await e.execute(t),console.log(`Table ${a} created or already exists`)}catch(e){if("ER_TABLE_EXISTS_ERROR"!==e.code)throw console.error(`Error creating table ${a}:`,e),e}}async function i(){let e;if(!o)try{e=await n.A.getConnection(),await E(e,"chatpanel_config",`CREATE TABLE IF NOT EXISTS chatpanel_config (
        ...
        FOREIGN KEY (page_id) REFERENCES chatpanel_pages(id) ON DELETE CASCADE
         ...
         ('owner', 'Full access to all features including role management', true);`),console.log("Inserted owner role"));let[i]=await e.execute("SELECT COUNT(*) as count FROM chatpanel_pages");0===i[0].count&&(await e.execute(`INSERT INTO chatpanel_pages (name, display_name, description) VALUES 
