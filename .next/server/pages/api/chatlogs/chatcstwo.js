"use strict";(()=>{var e={};e.id=783,e.ids=[783],e.modules={5600:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},6762:(e,t)=>{Object.defineProperty(t,"M",{enumerable:!0,get:function(){return function e(t,a){return a in t?t[a]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,a)):"function"==typeof t&&"default"===a?t:void 0}}})},8378:(e,t,a)=>{a.r(t),a.d(t,{config:()=>i,default:()=>u,routeModule:()=>d});var r={};a.r(r),a.d(r,{default:()=>l});var s=a(9947),n=a(2706),c=a(6762),o=a(4951);async function l(e,t){if("GET"!==e.method)return t.status(405).json({error:"Method not allowed"});let a=parseInt(e.query.page)||1,r=e.query.steamId||"",s=e.query.serverId||"",n=e.query.team||"",c=e.query.message||"",l=e.query.fromDate||"",u=e.query.toDate||"",i=e.query.steamIdNameIpFilter||"";try{let e=await o.A.getConnection();try{let o="1 = 1",d=[];r&&(o+=" AND cl.playerSteam64 = ?",d.push(r)),s&&(o+=" AND cl.serverId LIKE ?",d.push(`%${s}%`)),i&&(o+=` AND (cl.playerSteam64 LIKE ? OR cl.playerName LIKE ? OR 
          (SELECT st.playerIP 
         ...
         LIMIT ? OFFSET ?`,[...d,20,(a-1)*20]);return e.release(),t.status(200).json({items:A,totalItems:E,totalPages:m,currentPage:a})}catch(a){return e.release(),console.error("Database query error:",a),t.status(500).json({error:"Failed to fetch messages"})}}catch(e){return console.error("Database connection error:",e),t.status(500).json({error:"Database connection failed"})}}let u=(0,c.M)(r,"default"),i=(0,c.M)(r,"config"),d=new s.PagesAPIRouteModule({definition:{kind:n.A.PAGES_API,page:"/api/chatlogs/chatcstwo",pathname:"/api/chatlogs/chatcstwo",bundlePath:"",filename:""},userland:r})},4951:(e,t,a)=>{a.d(t,{A:()=>s});let r=require("mysql2/promise"),s=a.n(r)().createPool({host:process.env.DB_HOST,user:process.env.DB_USER,password:process.env.DB_PASSWORD,database:process.env.DB_NAME,waitForConnections:!0,connectionLimit:10,queueLimit:0})},2706:(e,t)=>{Object.defineProperty(t,"A",{enumerable:!0,get:function(){return a}});var a=function(e){return e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE",e.IMAGE="IMAGE",e}({})},9947:(e,t,a)=>{e.exports=a(5600)}};var t=require("../../../webpack-api-runtime.js");t.C(e);var a=t(t.s=8378);module.exports=a})();